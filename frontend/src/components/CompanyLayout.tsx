...
export default function CompanyLayout() {
  ...
  const nav = [
    { to: '/company', label: 'Dashboard', end: true, icon: ICON_HOME },
    { to: '/company/upload', label: 'Upload Documents', end: false, icon: ICON_UPLOAD },
    { to: '/company/reports', label: 'Reports', end: false, icon: ICON_DOCUMENT },
    ...(user?.role === 'company_admin'
      ? [{ to: '/company/team', label: 'Team', end: false, icon: ICON_USERS }]
      : []),
  ]
        ...
        <aside className="w-60 bg-slate-900 flex flex-col shrink-0">
          <div className="flex items-center gap-2.5 px-5 py-5">
            ...
            <div>
              ...
              <div className="text-slate-500 text-xs mt-0.5">Company Portal</div>
            </div>
          </div>
          ...
          <div className="px-3 py-4 border-t border-slate-800">
            <div className="flex items-center gap-2.5 px-2 mb-2">
              ...
              <div className="min-w-0">
                ...
                <div className="text-slate-500 text-xs truncate">Company</div>
              </div>
            </div>
            <button
